...
public class UserController {
    ...
    @GetMapping("/historic")
    public List<ProductDTO> getHistoricByUser(@AuthenticationPrincipal User user) throws Exception{
        List<Product> products = userService.getProductHistoric(user);
    ...
    public List<ProductDTO> getFavouriteByUser(@AuthenticationPrincipal User user) throws Exception{
        List<Product> products = userService.getProductHistoric(user);
        return products.stream()
                .map(product -> 
                        new ProductDTO(
    ...
    public void addProductFavourite(@RequestBody FavouriteDTO favourite, @AuthenticationPrincipal User user) throws Exception {
        userService.addProductHistoric(favourite.getProductId(), user);
    }
